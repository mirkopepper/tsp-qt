...
void MainWindow::on_actionAbout_2_triggered()
{
    ...
    About.setText("Trabajo de promoci&oacute;n de la c&aacute;tedra de An&aacute;lisis y Dise&ntilde;o de Algoritmos I de la Universidad del Centro de la Provincia de Buenos Aires, realizado por Mirko Hrubik y Lucas Obyszuk.<br/>Desarrollado con:<br/><br/>Qt 4.8.5<br/>Qt Creator 2.8.0<br/>GCC 4.8.1<br/>GNU/Linux 3.11.3<br/>Desarrollado bajo licencia GPL v3<br/>C&oacute;digo fuente:<br/><a href='https://github.com/mirkopepper/tsp-qt'>https://github.com/mirkopepper/tsp-qt</a>");
    About.exec();
}
